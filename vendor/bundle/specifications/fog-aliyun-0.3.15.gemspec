# -*- encoding: utf-8 -*-
# stub: fog-aliyun 0.3.15 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<aliyun-sdk>.freeze, ["~> 0.7.2"])
      s.add_runtime_dependency(%q<aliyun-sdk>.freeze, ["~> 0.7.2"])
      ...
      s.add_dependency(%q<aliyun-sdk>.freeze, ["~> 0.7.2"])
      s.add_dependency(%q<aliyun-sdk>.freeze, ["~> 0.7.2"])
